...
<div class="container" style="width: 1000px; margin: 0 auto; ">
	<div>
		...
		내용을 <br /> 바꿀 수 있도록 프로그램에서 접근하는 방법을 제공함 <br /> DOM은 속성과 메소드를 가지는 객체와
		<br />
		<mark>노드</mark>
		와 트리구조로 표현될 <br /> 웹페이지를 스크립트나 다른 개발 언어로 접근시 필수적
	</div>
	<div>
		<h3>document 객체</h3>
		DOM 객체의 최고 상위 객체. window 안에 있는 HTML 문서 자체를 <br /> document 라고 칭함. <br />
		<h3>element 객체</h3>
		...
		엘리먼트를 요소 노드라고 칭하며, 어트리뷰트는 속성노드 <br /> 내부의 글은 텍스트 노드라고 칭함. <br />
	</div>
	<div>
	...
	<div>
		<div><h3>document.createElement() 의 예제</h3></div>
