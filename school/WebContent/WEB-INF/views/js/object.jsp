...
<div class="container" style="width: 1000px; margin: 0 auto;">
	...
	<h3>브라우저 객체 BOM(Browser Object Model)</h3>
		...
		<h4>즉 , 브라우저 객체(BOM = Window 객체)은 <br/>
			브라우저 창이 열릴 때마다 하나씩 만들어지는 개체로써 <br />
	...
	<div style="margin-top: 30px">
		...
		<ul>
			...
			<li>딥 카피 : MemberService service = new MemberServiceImpl()</li>
			<li>쉘로우 카피 : MemberService service = MemberServiceImpl.getInstance()</li>
		</ul>
